...
const Login = (): React.ReactElement | null => {
  ...
  const handleChange = (field: string) => (e: InputEvent) => {
  ...
  const demo = React.createElement('div', { className: 'mt-6 text-center text-sm text-gray-600' },
  ...
  return React.createElement('div', { className: 'min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8' },
    React.createElement('div', { className: 'sm:mx-auto sm:w-full sm:max-w-md' },
      React.createElement('h2', { className: 'mt-6 text-center text-3xl font-extrabold text-gray-900' }, 'Sign in')
    ),
